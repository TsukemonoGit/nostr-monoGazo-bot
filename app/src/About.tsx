    ...
    return (
        <div class={style.container}>
            ...
            <div >
                ...
                <p class={css({ backgroundColor: 'rgba(255, 255, 255, 0.5)' })}>ものの部分はmonoでもOk</p>
                <div class={styles.grid}>
                    ...
                    <div class={styles.gridItem}>もの画像リストの[number]番の画像をリプライ（0始まり）</div>
                    ...
                    <div class={styles.gridItem}>リプライ</div>
                    <div class={styles.gridItem}>[nostr:npub~]さんにあるふぉふぉをおくる</div>

                    <div class={styles.gridItem}>ある（ん）ふぉふぉあげて</div>
                    <div class={styles.gridItem}>リプライ</div>
                    <div class={styles.gridItem}>TLにあるんふぉふぉを放流する</div>

                    <div class={styles.gridItem}>もの画像 枚数
                    </div>
                    <div class={styles.gridItem}>リプライ</div>
                    ...
                    <div class={styles.gridItem}>リプライ</div>
                    <div class={styles.gridItem}>和暦で今日の日付を教えてくれる<br />便利だね</div>
            ...
            <div class={css({ marginTop:"2rem" ,padding:"2rem"})}>
                <p class={css({ backgroundColor: 'rgba(255, 255, 255, 0.5)' })}>(以下管理者限定コマンド)</p>
                ...
                <div class={styles.grid}>
                    ...
                    <div class={styles.gridItem}>{"追加 {(追加するURLなど)}"}
                       </div>
                    <div class={styles.gridItem}>リプライ</div>
                    ...
                    <div class={styles.gridItem}></div>
                    <div class={styles.gridItem}>pointlog.jsonに保存され、現在のポイント獲得数をreactionする</div>
